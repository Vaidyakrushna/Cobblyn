...
[System.IO.Directory]::CreateDirectory($adminLayout) | Out-Null
[System.IO.File]::WriteAllText((Join-Path $adminLayout "layout.js"), "import AdminLayout from '../../src/pages/admin/AdminLayout';`nexport default function Layout({ children }) { return <AdminLayout>{children}</AdminLayout>; }")
