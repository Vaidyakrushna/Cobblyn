...
const submodels = {
  ...
  Oxford: [
    {
      ...
      tag: 'Most Classic',
      img: 'https://images.unsplash.com/photo-1614252369475-531eba835eb1?w=600&q=80&fit=crop',
    },
    {
      name: 'Cap Toe Oxford',
    ...
    },
    {
      ...
      tag: 'Most Luxurious',
      img: 'https://images.unsplash.com/photo-1573100925118-870b8efc799d?w=600&q=80&fit=crop',
    },
    {
      name: 'Semi-Brogue Oxford',
      desc: 'Subtle toe-cap broguing adds texture without overpowering the formal silhouette.',
      tag: '',
      img: 'https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=600&q=80&fit=crop',
    },
    {
  ...
  Derby: [
    {
      ...
      tag: 'Most Versatile',
      img: 'https://images.unsplash.com/photo-1616696038562-574c18066055?w=600&q=80&fit=crop',
    },
    {
      name: 'Cap Toe Derby',
  ...
  Loafer: [
    ...
    },
    {
      ...
      tag: 'Most Iconic',
      img: 'https://images.unsplash.com/photo-1627384113743-6bd5a479fffd?w=600&q=80&fit=crop',
    },
    {
      name: 'Tassel Loafer',
  ...
  'Monk Strap': [
    {
      ...
      tag: 'Most Popular',
      img: 'https://images.unsplash.com/photo-1770198408387-7f45e5d6c056?w=600&q=80&fit=crop',
    },
    {
      name: 'Double Monk',
  ...
  Ballerina: [
    ...
    },
    {
      ...
      tag: 'Most Elegant',
      img: 'https://images.unsplash.com/photo-1720604083961-88336789791e?w=600&q=80&fit=crop',
    },
    {
  ...
  WomenBoots: [
    {
      ...
      tag: 'Bestseller',
      img: 'https://images.unsplash.com/photo-1720603989488-1f3d16b7be9d?w=600&q=80&fit=crop',
    },
    {
          ...
          {step === 1 && (
            <div className="customize-step" data-testid="step-model">
              ...
              <div className="model-grid">
                {(activeModels[config.gender] || activeModels.men).map((m) => (
                  <button
                    key={m.name}
